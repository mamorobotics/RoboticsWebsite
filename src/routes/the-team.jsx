        ...
        <div className="page-body">
          ...
          <article>
            ...
            <div className="team-flex">
              ...
              <PersonCard src="./assets/team-images/mikey-mcmanus.jpg" name="Mikey McManus" title="Engineer" 
            ...
            <div className="team-flex">
              <PersonCard src="./assets/team-images/mustafa-khan.jpg" name="Mustafa Khan" title="Coder" 
            ...
            <div className="team-flex">
              ...
              <PersonCard src="./assets/team-images/maya-okochu.png" name="Maya Okochu" title="Documentation & Outreach" 
              ...
              <PersonCard src="./assets/team-images/sanjana-tata.png" name="Sanjana Tata" title="Documentation & Outreach" 
