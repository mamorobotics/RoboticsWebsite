    ...
    <>
      <Body sub="A lot of people all working on one robot">
        <div className="space-y-2">
          ...
          <div className="grid-cols-6 gap-3 max-sm:space-y-3 sm:grid landscape:max-lg:grid-cols-2">
            <PersonCard
              src={
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/elise-carpenter.jpg"
              name="Elise Carpenter"
              title="Head of Engineering"
              description="[DESCRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/miles-conto.jpg"
              name="Miles Contopoulos"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/alondra-avila.jpg"
              name="Alondra Avila"
              title="Head of Documentation & Outreach"
          ...
          <div className="grid-cols-6 gap-3 max-sm:space-y-3 sm:grid landscape:max-lg:grid-cols-2">
            <PersonCard
              ...
              name="Graham Welsh"
              title="Head of Assembely"
              description="[DESRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/sam-sklar"
              name="Sam Sklar"
              title="Engineer"
              description="[DESRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/nate-metch.png"
              name="Nate Metsch"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/liam-delamora"
              name="Liam DeLaMora"
              title="Engineer"
              description="[DESRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/paolo-dapkins"
              name="Paolo Dapkins"
              title="Engineer"
              description="[DESRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/alex-lin.jpg"
              name="Alex Lin"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/greg-mirando"
              name="Greg Mirando"
              title="Engineer"
              description="[DESRIPTION]"
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/sophie-steinberg"
              name="Sophie Steinberg"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/jonathan-wittick.jpg"
              name="Jonathan Wittick"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/harper-morgan"
              name="Harper Morgan"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/finn-schweter"
              name="Finn Schweter"
              title="Engineer"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/mikey-mcmanus.jpg"
              name="Mikey McManus"
              title="Engineer"
          ...
          <div className="grid-cols-6 gap-3 max-sm:space-y-3 sm:grid landscape:max-lg:grid-cols-2">
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/dylan-toland.jpg"
              name="Dylan Toland"
              title="Coder"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/christian-valdehueza.jpg"
              name="Christian Paul Valdehueza"
              title="Coder"
          ...
          <div className="grid-cols-6 gap-3 max-sm:space-y-3 sm:grid landscape:max-lg:grid-cols-2">
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/daniel-mccance"
              name="Daniel McCance"
              title="Documentation & Outreach"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/maya-okochu.png"
              name="Maya Okochu"
              title="Documentation & Outreach"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/elise-conto"
              name="Elise Contopoulos"
              title="Documentation & Outreach"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/sanjana-tata.png"
              name="Sanjana Tata"
              title="Documentation & Outreach"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/aelx-tombleson"
              name="Alex Tombleson"
              title="Documentation & Outreach"
            ...
            />
            <PersonCard
              src="https://raw.githubusercontent.com/mamorobotics/RoboticsWebsite/main/assets/team-images/maria-aguilera.jpg"
              name="Maria K. Torres Aguilera"
              title="Documentation & Outreach"
